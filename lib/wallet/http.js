...
class HTTP extends Server {
  ...
  initRouter() {
    ...
    this.get('/wallet/:id/tx/history', async (req, res) => {
      ...
      // TODO support pagination here. Only query for
      // confirmed transactions at this endpoint, and
      // support options as documented in bcoin#559.
    ...
    this.get('/wallet/:id/tx/unconfirmed', async (req, res) => {
      ...
      // TODO support pagination here. Only query for
      // unconfirmed transactions at this endpoint, and
      // support options as document in bcoin#559
    ...
    // Deprecated. Use history endpoint with time and sort options.

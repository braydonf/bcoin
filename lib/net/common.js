...
/**
 * Maximum number of headers requests.
 * @const {Number}
 * @default
 */

exports.MAX_HEADERS_REQUEST = 2000;

/**
 * Maximum rate (per minute) of unrequested headers
 * (announcements) that can be made from a peer.
 * @const {Number}
 * @default
 */

exports.MAX_HEADERS_RATE = 2000;

/**
 * Maximum delay (in milliseconds) in requesting the
 * next set of headers in a chain.
 * @const {Number}
 * @default
 */

exports.MAX_HEADERS_DELAY = 10000;

/**
 * Maximum rate (per minute) of header announcements
 * that do not connect to the chain.
 * @const {Number}
 * @default
 */

exports.MAX_HEADERS_UNCONNECTED = 3;

/**
 * How far ahead of the current chain tip to request blocks.
 * @const {Number}
 * @default
 */

exports.BLOCK_DOWNLOAD_WINDOW = 1024;

/**
 * How many blocks to request at one time from a single peer.
 * @const {Number}
 * @default
 */

exports.MAX_BLOCKS_PER_PEER = 128;
